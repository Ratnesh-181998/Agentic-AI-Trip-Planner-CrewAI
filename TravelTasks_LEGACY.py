...
# ============================================================================
# LEGACY TASKS - RECONSTRUCTED FROM JAPAN LOG (2025-12-05)
# ============================================================================

def location_task_legacy(agent, from_city, destination_city, date_from, date_to, num_adults=2, num_children=0):
    return Task(
        description=f"""
        ...
        **IMPORTANT**: After your research, write a COMPLETE markdown report with ALL sections above using this exact format with specific names, prices, and details. Do NOT just list search queries!
        ...
        expected_output="A detailed markdown report covering transportation options, accommodation choices (budget, mid-range, luxury), cost of living analysis, weather forecast, and visa/documentation requirements."
    )

def guide_task_legacy(agent, destination_city, interests, date_from, date_to):
    return Task(
        description=f"""
        ...
        **IMPORTANT**: After your research, write a COMPLETE guide with ALL 10-15 attractions (with descriptions, fees, times), 8-10 restaurants (with dishes and prices), specific activities for each interest, events during travel dates, and 3-5 hidden gems. Do NOT just list search queries!
        ...
        expected_output="A comprehensive markdown guide including top 10-15 attractions, 8-10 food recommendations, activities based on interests, local events, and hidden gems."
    )

def planner_task_legacy(context, agent, destination_city, interests, date_from, date_to, num_adults=2, num_children=0):
    return Task(
        description=f"""
        ...
        **YOUR TASK:**
        1. Analyze the context provided by the Location Expert and Guide Expert.
        2. Do 2-3 web searches ONLY if specific details (like current prices or opening hours) are missing from their reports.
        3. Then IMMEDIATELY write the complete final itinerary with ALL sections below.
        4. Include specific names, timings, and prices for everything.
        5. **NEVER leave brackets [] empty**. Fill them with real data.
        
        **Required Structure (Must Include ALL in your FINAL ANSWER):**
        
        **CRITICAL INSTRUCTION**: You must use the 'context' provided by the previous agents (Location Expert and Guide Expert) to fill in this itinerary. Do NOT ignore their findings. 
        - If they found specific hotels, USE THEM.
        - If they found specific restaurants, USE THEM.
        - If they found specific costs, USE THEM.
        - Do NOT output generic placeholders like "[Specific restaurant name]" if you have the data in the context.
        - If data is missing in the context, use your search tool to find it specifically.
        ...
        **IMPORTANT**: Write the COMPLETE itinerary with ALL 4 detailed paragraphs (5-7 sentences each), ALL days with full morning/afternoon/evening/night details, COMPLETE budget breakdown with calculations, ALL practical tips in every category, and COMPLETE packing checklist. Do NOT just list search queries!
        ...
        expected_output="A complete day-by-day itinerary with 4 detailed city introduction paragraphs, daily schedules (morning, afternoon, evening, night), detailed budget breakdown, practical tips, and packing checklist."
    )
